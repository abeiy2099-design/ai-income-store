      ...
      <div className="max-w-2xl mx-auto px-4 text-center">
        <div className="bg-white rounded-2xl shadow-2xl p-12 border-2 border-[#00D4FF]">
          ...
          <p className="text-xl text-gray-600 mb-8" style={{ fontFamily: 'Poppins, sans-serif' }}>
            Thank you for booking your consulting session with JENA Tech.
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <div className="bg-[#F5F5F7] p-6 rounded-lg">
              ...
              <p className="text-gray-600 text-sm" style={{ fontFamily: 'Poppins, sans-serif' }}>
                We've sent confirmation and meeting details to your email
              </p>
            </div>
            ...
            <div className="bg-[#F5F5F7] p-6 rounded-lg">
              ...
              <p className="text-gray-600 text-sm" style={{ fontFamily: 'Poppins, sans-serif' }}>
                You'll receive reminders 24h and 1h before your session
              </p>
            </div>
          </div>

          <div className="bg-gradient-to-r from-[#FFC300] to-[#FF8C00] text-[#2C2E83] p-6 rounded-lg mb-8">
            <p className="font-bold text-lg mb-2" style={{ fontFamily: 'Montserrat, sans-serif' }}>
              What's Next?
            </p>
            <p className="text-sm" style={{ fontFamily: 'Poppins, sans-serif' }}>
              Please check your email for the meeting link and prepare any questions or goals you'd like to discuss during your session.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            >
              Book Another Session <ArrowRight size={20} />
            </Link>
